...
t =  setInterval(function()
{
    ...
    console.log("Max Bid: %s %c(Time Left to Auto Bid: %sd %sh %sm %ss)",maxBidAmount, 'color:green',  new Date(timeLeft).getUTCDay(), new Date(timeLeft).getUTCHours(),new Date(timeLeft).getUTCMinutes(),new Date(timeLeft).getUTCSeconds() )
